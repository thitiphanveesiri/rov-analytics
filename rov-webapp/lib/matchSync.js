  ...
  for (const m of matches) {
    ...
    games.forEach((g, i) => {
      ...
      gameRows.push({
        ...
        // หัก pauseDuration (ถ้ามี) ออกก่อนเก็บ — ให้ตรงกับวิธีคำนวณ
        // avgGameDuration ฝั่ง client (RovApp.js Overview) เวลาที่จดไว้ดิบๆ
        // รวมช่วงที่เกมหยุดด้วย ไม่ใช่เวลาเล่นจริง
